...
map("n", "m", "'Nn'[v:searchforward].'zv'", { expr = true, desc = "Next Search Result" })
map("x", "m", "'Nn'[v:searchforward]", { expr = true, desc = "Next Search Result" })
map("o", "m", "'Nn'[v:searchforward]", { expr = true, desc = "Next Search Result" })
map("n", "M", "'nN'[v:searchforward].'zv'", { expr = true, desc = "Prev Search Result" })
map("x", "M", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
map("o", "M", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
